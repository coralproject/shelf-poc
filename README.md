...
If you want to create dummy data for testing:
  ...
  2. Define the example environmental variables in [dummy.env](shelfdummy/dummy.env).  Modify it according to where `sponged` is installed and how many documents you want to generate.
